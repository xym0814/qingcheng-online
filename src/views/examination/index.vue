    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="正式考试" name="first">
        ...
        <div class="data_table">
          ...
          >
            <el-table-column label="考试名称" width="180" align="center">
...
<!--              <span>60</span>-->
            ...
            <el-table-column label="考试状态" align="center">
              <template slot-scope="scope">
<!--                <span>{{new Date() > new Date(scope.row.endTime)}}</span>-->
<!--                <span>{{new Date()}}</span>-->
<!--                <span>{{new Date(scope.row.endTime)}}</span>-->
      ...
      <el-tab-pane label="模拟考试" name="second"> </el-tab-pane>
    </el-tabs>
  </div>
</template>
